...
inline std::string TrimmedFront(std::string& str) { std::string s; TrimFront(s); return s; }
inline std::string TrimmedBack(std::string& str) { std::string s; TrimBack(s); return s; }
inline std::string Trimmed(std::string& str) { std::string s; Trim(s); return s; }
